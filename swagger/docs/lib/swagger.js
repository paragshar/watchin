...
(function() {
  ...
  SwaggerApi = (function() {
    ...
    SwaggerApi.prototype.docsPath = null;
    ...
    SwaggerApi.prototype.build = function() {
      ...
      return jQuery.getJSON(this.discoveryUrl, function(response) {
        ...
        if ((response.docsPath != null) && jQuery.trim(response.docsPath).length > 0) {
          _this.docsPath = response.docsPath;
          if (_this.docsPath.match(/^HTTP/i) == null) {
            _this.fail("discoveryUrl docsPath must be a URL.");
          }
          _this.docsPath = _this.docsPath.replace(/\/$/, '');
        } else {
          _this.docsPath = _this.discoveryUrl.substring(0, _this.discoveryUrl.lastIndexOf('/'));
          log('derived docsPath from discoveryUrl as ' + _this.docsPath);
        }
        _this.resources = {};
  ...
  SwaggerResource = (function() {
    ...
    function SwaggerResource(resourceObj, api) {
      ...
      this.basePath = this.api.docsPath;
      this.baseRequestPath = this.api.basePath;
      this.operations = {};
      ...
      if ((resourceObj.operations != null) && (this.api.resourcePath != null)) {
        ...
        this.url = this.api.suffixApiKey(this.basePath + this.path.replace('{format}', 'json'));
        if(this.url.indexOf("docs") != -1) {
            this.url += '.json';
        }
        ...
        jQuery.getJSON(this.url, function(response) {
          ...
          //if ((response.basePath != null) && jQuery.trim(response.basePath).length > 0) {
          //  _this.basePath = response.basePath;
            _this.basePath = _this.baseRequestPath;
          //}
          if (response.apis) {
            _ref = response.apis;
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    ...
    SwaggerResource.prototype.addOperations = function(resource_path, ops) {
      ...
      if (ops) {
        ...
        for (_i = 0, _len = ops.length; _i < _len; _i++) {
          o = ops[_i];
          op = new SwaggerOperation(o.nickname, resource_path, o.httpMethod, o.parameters, o.summary, o.notes, o.errorResponses, this);
  ...
  SwaggerOperation = (function() {
    ...
    function SwaggerOperation(nickname, path, httpMethod, parameters, summary, notes, errors, resource) {
